...
public class CatalogController {
    ...
    public CatalogController(LocalDataStore localDataStore, PricingService pricingService) {
    ...
    public List<SubjectResponse> subjects() {
        return localDataStore.getAllSubjects().stream()
                .map(s -> new SubjectResponse(s.id(), s.code(), s.name()))
                .toList();
    }
